...
<head>
    ...
    <link rel="apple-touch-icon" href="http://127.0.0.1:8000/resources/app-assets/images/ico/apple-icon-120.png CHANGE">
    <link rel="shortcut icon" type="image/x-icon" href="http://127.0.0.1:8000/resources/app-assets/images/ico/favicon.ico  CHANGE">
    <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i%7CQuicksand:300,400,500,700" rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="http://127.0.0.1:8000/resources/app-assets/fonts/material-icons/material-icons.css CHANGE">

    <!-- BEGIN: Vendor CSS-->
    <link rel="stylesheet" type="text/css" href="http://127.0.0.1:8000/resources/app-assets/vendors/css/material-vendors.min.css">
    <link rel="stylesheet" type="text/css" href="http://127.0.0.1:8000/resources/app-assets/vendors/css/ui/prism.min.css">
    <!-- END: Vendor CSS-->

    <!-- BEGIN: Theme CSS-->
    <link rel="stylesheet" type="text/css" href="http://127.0.0.1:8000/resources/app-assets/css/material.css">
    <link rel="stylesheet" type="text/css" href="http://127.0.0.1:8000/resources/app-assets/css/components.css">
    <link rel="stylesheet" type="text/css" href="http://127.0.0.1:8000/resources/app-assets/css/bootstrap-extended.css">
    <link rel="stylesheet" type="text/css" href="http://127.0.0.1:8000/resources/app-assets/css/material-extended.css">
    <link rel="stylesheet" type="text/css" href="http://127.0.0.1:8000/resources/app-assets/css/material-colors.css">
    <!-- END: Theme CSS-->

    <!-- BEGIN: Page CSS-->
    <link rel="stylesheet" type="text/css" href="http://127.0.0.1:8000/resources/app-assets/css/core/menu/menu-types/material-horizontal-menu.css">
    <!-- END: Page CSS-->

    <!-- BEGIN: Custom CSS-->
    <link rel="stylesheet" type="text/css" href="http://127.0.0.1:8000/resources/assets/css/style.css">
    <!-- END: Custom CSS-->
...
<body class="horizontal-layout horizontal-menu horizontal-menu-padding material-horizontal-layout material-layout 2-columns  " data-open="click" data-menu="horizontal-menu" data-col="2-columns">
        ...
        <div class="navbar-wrapper">
            <div class="navbar-header">
                <ul class="nav navbar-nav flex-row">
                    ...
                    <li class="nav-item"><a class="navbar-brand" href="http://127.0.0.1:8000/resources/html/ltr/material-horizontal-menu-template/index.html"><img class="brand-logo" alt="modern admin logo" src="http://127.0.0.1:8000/resources/app-assets/images/logo/logo.png">
    ...
    <div class="header-navbar navbar-expand-sm navbar navbar-horizontal navbar-fixed navbar-dark navbar-without-dd-arrow navbar-shadow" role="navigation" data-menu="menu-wrapper">
        <div class="navbar-container main-menu-content container center-layout" data-menu="menu-container">
            <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
                <li class="nav-item"><a class="nav-link" href="http://127.0.0.1:8000/resources/html/ltr/material-horizontal-menu-template/index.html"><i class="material-icons">important_devices</i><span>Dashboard</span></a></li>
                <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#" data-toggle="dropdown"><i class="material-icons">code</i><span data-i18n="Starter kit">Starter kit</span></a>
                    <ul class="dropdown-menu">
                        <li data-menu=""><a class="dropdown-item" href="horizontal-layout-1-column.html" data-toggle=""><span data-i18n="1 column">1 column</span></a>
                        </li>
                ...
                <li class="nav-item"><a class="nav-link" href="https://pixinvent.ticksy.com/" target="_blank"><i class="material-icons">label_outline</i><span>Raise Support</span></a></li>
                <li class="nav-item"><a class="nav-link" href="https://pixinvent.com/modern-admin-clean-bootstrap-4-dashboard-html-template/documentation" target="_blank"><i class="material-icons">format_size</i><span>Documentation</span></a></li>
            </ul>
        </div>
    </div>
            ...
            <div class="content-header-dark bg-img col-12">
                <div class="row">
                    <div class="content-header-left col-md-9 col-12 mb-2">
                        <h3 class="content-header-title white">1 Column</h3>
    ...
    <!-- BEGIN: Vendor JS-->
    <script src="http://127.0.0.1:8000/resources/app-assets/vendors/js/material-vendors.min.js"></script>
    <!-- BEGIN Vendor JS-->

    <!-- BEGIN: Page Vendor JS-->
    <script src="http://127.0.0.1:8000/resources/app-assets/vendors/js/ui/jquery.sticky.js"></script>
    <script src="http://127.0.0.1:8000/resources/app-assets/vendors/js/ui/prism.min.js"></script>
    <!-- END: Page Vendor JS-->

    <!-- BEGIN: Theme JS-->
    <script src="http://127.0.0.1:8000/resources/app-assets/js/core/app-menu.js"></script>
    <script src="http://127.0.0.1:8000/resources/app-assets/js/core/app.js"></script>
    <!-- END: Theme JS-->

    <!-- BEGIN: Page JS-->
    <script src="http://127.0.0.1:8000/resources/app-assets/js/scripts/pages/material-app.js"></script>
    <!-- END: Page JS-->
